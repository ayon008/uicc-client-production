...
import img1 from '../../../../public/assets/group-college-students-studying-together-library-min.jpeg.jpg'
import img2 from '../../../../public/assets/multiethnic-business-group-brainstorming-about-marketing-plan-immaculate-min.jpeg.jpg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'Special Topik Course'} img={img1} />

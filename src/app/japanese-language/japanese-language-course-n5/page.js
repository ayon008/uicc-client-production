...
import img1 from '../../../../public/assets/IMG_1556.JPEG.jpg'
import img2 from '../../../../public/assets/IMG_1557.JPEG.jpg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'Japanese Language'} text2={'Course N5'} img={img1} />

...
import img1 from '../../../../public/assets/experienced-employee-instructing-newcomers.jpg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'Japanese Language Course'} text2={'N5 N4 Combined'} img={img1} />

...
import img1 from '../../../../public/assets/english-books-stacks-table-working-space-min.jpeg.jpg'
import img2 from '../../../../public/assets/young-students-learning-library-bookshelves-min.jpeg.jpg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'English Grammer'} text2={'Fitness Course'} img={img1} />

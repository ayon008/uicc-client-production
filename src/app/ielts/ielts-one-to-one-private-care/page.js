...
import img1 from '@/../public/assets/young-foreign-student-english-language-lesson.jpg'
import img2 from '@/../public/assets/foreign-school-private-study-smile-laught-with-school-girl-teacher-explain-grammar-native-language-using-laptop-min.jpeg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'IELTS One to One'} text2={'Private Care'} img={img1} />

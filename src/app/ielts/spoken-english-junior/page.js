...
import img1 from '../../../../public/assets/IMG_1555.JPEG.jpg'
import img2 from '../../../../public/assets/pupils-raising-hand-classroom-min.jpg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'Spoken'} text2={'English Junior'} img={img1} />

...
import img1 from '@/../public/assets/cdc-GDokEYnOfnE-unsplash.jpg'
import img2 from '@/../public/assets/thought-catalog-RdmLSJR-tq8-unsplash.jpg'
...
const Page = () => {
    return (
        <div>
            <ServiceBanner text1={'Spoken English Junior'} />

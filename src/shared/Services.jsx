    ...
    return (
        <div className="2xl:px-10 xl:px-8 2xl:py-6 xl:py-4 flex flex-col h-full">
            ...
            <div className="h-full flex flex-col justify-between">
                <p className={`text-orange 2xl:text-2xl xl:text-xl ${color === 'black' ? 'text-deep-blue' : 'text-white'} font-bold mb-2 `}>{heading}</p>
                <h1 className={`2xl:text-3xl xl:text-2xl ${color === 'black' ? 'text-deep-blue' : 'text-white'} font-semibold`}>{subHeading}</h1>
